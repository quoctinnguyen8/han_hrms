...
ALTER TABLE contracts ADD COLUMN employee_code VARCHAR(30) NOT NULL COMMENT 'Mã nhân viên';
ALTER TABLE contracts
ADD CONSTRAINT fk_employee_code
FOREIGN KEY (employee_code) REFERENCES employees(employee_code);

ALTER TABLE contracts ADD COLUMN salary_detail_id INT NOT NULL COMMENT 'ID chi tiết lương';
ALTER TABLE contracts
