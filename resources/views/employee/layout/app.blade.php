...
<head>
    ...
    <meta content="Hệ thống quản lý nhân sự - Danh Kiều Hân" name="description" />
...
<body>
    ...
    <div id="layout-wrapper">
        @include('employee.layout.topbar')
    ...
    <!-- Theme Settings -->
    @include('employee.layout.theme-setting')
    @yield('modal')
